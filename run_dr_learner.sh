...
echo "=========================================="
echo "Running DR-learner Uplift Modeling"
echo "=========================================="
...
echo "All required data files found. Starting DR-learner..."
echo ""

# Run the DR-learner script
python dr_learner/run_dr_learner.py --data_folder "$DATA_FOLDER"

echo ""
echo "=========================================="
echo "DR-learner completed successfully!"
echo "=========================================="
